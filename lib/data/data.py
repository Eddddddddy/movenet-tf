...
class Data():
    def __init__(self, cfg, dataset_h5=[], datasetval_h5=[]):
        ...
        #     self.dataset_h5 = f
        # with h5py.File(cfg['datasetval_h5'], 'r') as fv:
        #     self.datasetval_h5 = fv
        self.dataset_h5 = dataset_h5
        self.datasetval_h5 = datasetval_h5
    ...
    def getTrainValDataloader(self):
        ...
        train_loader, val_loader, train_loader_x, train_loader_y, train_loader_z= getDataLoader("trainval",
                                                                                 input_data,
                                                                                 self.cfg,
                                                                                 self.dataset_h5,
                                                                                 self.datasetval_h5)
        return train_loader, val_loader, train_loader_x, train_loader_y, train_loader_z, len(train_label_list), len(val_label_list)
